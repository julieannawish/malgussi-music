const CACHE='malgussi-v432';
const ASSETS=['./','./index.html','./manifest.webmanifest','./dog_default.png','./profile_default.png','./app-icon.png','./app-icon-192.png','./app-icon-maskable.png'];
